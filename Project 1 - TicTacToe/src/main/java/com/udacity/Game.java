...
public class Game {
    ...
    public String checkGameWinner(char [][]grid){
        ...
        // Check diagonals
        // Check main diagonal
        int mainDiagonal_x = 0;
        int mainDiagonal_O = 0;
        ...
        for (int i = 0; i < grid.length; i++) {
            for (int j = 0; j < grid.length; j++) {
                if (i == grid.length - j - 1 && grid[i][j] == 'x') {
                    antiDiagonal_x++;
                }
                if (i == grid.length - j - 1 && grid[i][j] == 'o') {
                    antiDiagonal_O++;
                }
            }
        }
        ...
        if (mainDiagonal_x == 3 || antiDiagonal_x == 3) {
            result = "X wins";
        }
        if (mainDiagonal_O == 3 || antiDiagonal_O == 3) {
            result = "O wins";
        }
        if (lineO1 == 3 ||
            lineO2 == 3 ||
